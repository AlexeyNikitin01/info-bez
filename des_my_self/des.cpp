...
bitset<64> DES_encryp(bitset<64> &plain, vector<bitset<48>> subkey) {
	bitset<64> cipher;
...
bitset<64> DES_decrypt(bitset<64> & cipher, vector<bitset<48>> subkey) {
	bitset<64> plain;
	bitset<64> currentBits;
	bitset<32> left;
	bitset<32> right;
...
void show_decrypt(bitset<64> chiper, vector<bitset<48>> subkey) {
